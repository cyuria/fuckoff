...
from .utils import Rule, CorrectedCommand

from fuckoff import corrector, const
from fuckoff.types import Command
from fuckoff.corrector import get_corrected_commands, organize_commands
...
def test_get_corrected_commands(mocker):
    ...
    mocker.patch('fuckoff.corrector.get_rules', return_value=rules)
...
def test_organize_commands():
    ...
    assert list(
        organize_commands(command for command in commands)
    ) == [
